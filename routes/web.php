...
Route::get('/profile/reservation/cancel/{id}', [ReservationController::class, 'cancel'])->name('profile.reservation.cancel');
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/dishes/delete/{id}', [AdminController::class, 'deleteDish'])->name('admin.dishes.delete');
    ...
    Route::get('/reservations/delete/{id}', [AdminController::class, 'deleteReservation'])->name('admin.reservations.delete');
});